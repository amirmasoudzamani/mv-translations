...
* Description: Manage song translations, singers, transliterations, videos, and user-submitted lyrics in WordPress
* Version: 1.0
* Requires at least: 5.6
* Requires PHP: 7.0
* Author: Amirmasoud Zamani
* Author URI: https://codeexplore.ir
...
if( !class_exists( 'MV_Translations' )){
	...
	class MV_Translations{
        ...
        public function load_textdomain() {
            load_plugin_textdomain('mv-translations', false, dirname(plugin_basename(__FILE__)) . '/languages');
        }
        /**
         * Activate the plugin
         */
        ...
        public function register_scripts() {
            wp_register_script('custom_js', MV_TRANSLATIONS_URL . 'assets/jquery.custom.js', ['jquery'], MV_TRANSLATIONS_VERSION, true);
            wp_register_script('validate_js', MV_TRANSLATIONS_URL . 'assets/jquery.validate.min.js', ['jquery'], MV_TRANSLATIONS_VERSION, true);

            if(is_singular('mv-translations')) {
                wp_enqueue_style('mv-translations', MV_TRANSLATIONS_URL . 'assets/style.css', [], MV_TRANSLATIONS_VERSION, 'all');
            }
        }
